...
if option == "📚 Home":
    st.markdown(
        ...
        <div class="fade-in" style="text-align: ;">
            <h1 style="margin-bottom:15px;">📚 Your Personal Library Hub is Here!</h1>
            <p style="color:#888;">📖
                Effortlessly organize your books, moniter your reading journey, and dive into insightful stats with this interactive place.
            </p>
        </div>
        """,
        unsafe_allow_html=True,
...
st.markdown("---")
st.markdown("""
    <p style='text-align: center; color: gray;'>© 2025 Library Manager | Created by Rida Danish 🔥</p>
""", unsafe_allow_html=True)